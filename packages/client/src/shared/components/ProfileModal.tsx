...
import { Edit3, Save, Lock, Key, Copy, Trash2, Bell, X } from 'lucide-react';
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="pointer-events-auto glass-panel w-[90vw] max-w-[860px] max-h-[85vh] flex overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Left: Profile card */}
              <div className="w-[240px] shrink-0 p-6 flex flex-col items-center gap-4 border-r border-white/5">
                {profile && (
                  <>
                ...
                <Button variant="ghost" className="w-full" onClick={close} sound="click">关闭</Button>
              </div>
