...
export type GatewayConnectArgs = {
...
export type GatewaySetState = (
  partial: Partial<GatewayStore> | ((state: GatewayStore) => Partial<GatewayStore>),
) => void;
...
export type GatewayStore = {
  ...
  init: () => void;
  disconnect: () => void;
  connect: (args: GatewayConnectArgs) => void;
  resetError: () => void;
