...
const song: Song = {
  name: 'Shuffle',
  meta: { author: 'Claude Opus 4.6', key: 'C 大调', style: '轻快摇曳', wave: '方波' },
  bpm: 96,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.1, dur: 0.18, notes: join(mA, mB, mC, mD, mE, mA, mB, mF) },
    { wave: 'square', gain: 0.04, dur: 0.15, notes: join(hA, hB, hA, hD, hE, hA, hB, hF) },
    { wave: 'triangle', gain: 0.15, dur: 0.2, notes: join(bA, bB, bA, bD, bE, bA, bB, bF) },
  ],
