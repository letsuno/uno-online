...
const song: Song = {
  name: 'UNO Bounce',
  meta: { author: 'Claude Opus 4.6', key: 'C 大调', style: '弹跳琶音', wave: '方波' },
  bpm: 138,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.15, dur: 0.1, notes: join(mA, mC, mB, mD, mE, mA, mB, mF) },
    { wave: 'square', gain: 0.07, dur: 0.12, notes: join(hA, hA, hB, hD, hE, hA, hB, hF) },
    { wave: 'triangle', gain: 0.18, dur: 0.15, notes: join(bA, bA, bB, bD, bE, bA, bB, bF) },
  ],
  kick: { gain: 0.2, hits: [...rep([T, F, F, F, T, F, F, F], 31), T, F, F, T, T, F, T, F] },
  snare: { gain: 0.1, hits: [...rep([F, F, T, F, F, F, T, F], 31), F, F, T, F, T, F, T, T] },
  hihat: {
    gain: 0.04,
    hits: [
