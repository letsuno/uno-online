...
const song: Song = {
  name: 'Blitz',
  meta: { author: 'Claude Opus 4.6', key: 'G 大调', style: '进行曲', wave: '锯齿波' },
  bpm: 135,
  stepsPerBeat: 2,
  tones: [
    { wave: 'sawtooth', gain: 0.1, dur: 0.1, notes: join(mA, mB, mC, mA, mD, mA, mB, mE) },
    { wave: 'square', gain: 0.06, dur: 0.12, notes: join(hA, hB, hC, hA, hD, hA, hB, hE) },
    { wave: 'triangle', gain: 0.18, dur: 0.15, notes: join(bA, bB, bC, bA, bD, bA, bB, bE) },
  ],
  kick: {
    gain: 0.2,
    hits: [
  ...
  snare: { gain: 0.1, hits: [...rep([F, F, T, F, F, F, T, F], 31), F, F, T, T, F, T, T, T] },
