...
const song: Song = {
  name: 'Color Wheel',
  meta: { author: 'Claude Opus 4.6', key: 'C 大调', style: '回旋轮盘', wave: '方波' },
  bpm: 120,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.14, dur: 0.12, notes: join(mA, mB, mA, mC, mA, mB, mA, mD) },
    { wave: 'square', gain: 0.06, dur: 0.14, notes: join(hA, hB, hA, hC, hA, hB, hA, hD) },
    { wave: 'triangle', gain: 0.17, dur: 0.16, notes: join(bA, bB, bA, bC, bA, bB, bA, bD) },
  ],
  kick: { gain: 0.18, hits: rep([T, F, F, F, T, F, F, F], 32) },
  snare: { gain: 0.09, hits: rep([F, F, T, F, F, F, T, F], 32) },
  hihat: { gain: 0.04, hits: [...rep([T, F, T, F, T, F, T, F], 16), ...rep([T, T, T, T, T, T, T, T], 16)] },
};
export default song;
