...
const song: Song = {
  name: 'Wild Card',
  meta: { author: 'Claude Opus 4.6', key: 'A 小调', style: '极速冲刺', wave: '方波' },
  bpm: 148,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.15, dur: 0.09, notes: join(mA, mA, mB, mB, mC, mC, mD, mD) },
    { wave: 'square', gain: 0.07, dur: 0.11, notes: join(hA, hA, hB, hB, hC, hC, hD, hD) },
    { wave: 'triangle', gain: 0.18, dur: 0.13, notes: join(bA, bA, bB, bB, bC, bC, bD, bD) },
  ],
  kick: {
    gain: 0.22,
    hits: [
  ...
  snare: { gain: 0.1, hits: [...rep([F, F, T, F, F, F, T, F], 31), F, T, T, F, T, T, F, T] },
