...
const song: Song = {
  name: 'Sunset',
  meta: { author: 'Claude Opus 4.6', key: 'F 大调', style: '日落音乐盒', wave: '三角波' },
  bpm: 78,
  stepsPerBeat: 2,
  tones: [
    { wave: 'triangle', gain: 0.12, dur: 0.3, notes: join(mA, mB, mC, mA, mD, mB, mC, mE) },
    { wave: 'sine', gain: 0.03, dur: 0.22, notes: join(hA, hB, hC, hA, hD, hB, hC, hE) },
    { wave: 'triangle', gain: 0.08, dur: 0.35, notes: join(bA, bB, bC, bA, bD, bB, bC, bE) },
  ],
