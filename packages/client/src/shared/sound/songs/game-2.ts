...
const song: Song = {
  name: 'Reverse!',
  meta: { author: 'Claude Opus 4.6', key: 'A 小调', style: '切分律动', wave: '方波' },
  bpm: 128,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.15, dur: 0.1, notes: join(mA, mB, mC, mD, mE, mA, mF, mD) },
    { wave: 'square', gain: 0.07, dur: 0.12, notes: join(hA, hB, hC, hD, hE, hA, hF, hD) },
    { wave: 'triangle', gain: 0.18, dur: 0.15, notes: join(bA, bB, bC, bD, bE, bA, bF, bD) },
  ],
  kick: {
    gain: 0.2,
    hits: [
      ...rep([T, T, F, F, T, F, F, T], 8),
      ...rep([T, F, F, F, T, F, F, F], 8),
      ...rep([T, F, F, F, F, F, F, F], 8),
