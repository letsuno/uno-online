...
const song: Song = {
  name: 'Breeze',
  meta: { author: 'Claude Opus 4.6', key: 'G 大调', style: '田园清风', wave: '正弦波' },
  bpm: 84,
  stepsPerBeat: 2,
  tones: [
    { wave: 'sine', gain: 0.12, dur: 0.25, notes: join(mA, mB, mA, mC, mA, mB, mA, mD) },
    { wave: 'sine', gain: 0.04, dur: 0.2, notes: join(hA, hB, hA, hC, hA, hB, hA, hD) },
    { wave: 'triangle', gain: 0.1, dur: 0.3, notes: join(bA, bB, bA, bC, bA, bB, bA, bD) },
  ],
  kick: { gain: 0.1, hits: rep([T, F, F, F, F, F, F, F], 32) },
