...
const song: Song = {
  name: 'Waiting Room',
  meta: { author: 'Claude Opus 4.6', key: 'C 大调', style: '温暖柔和', wave: '方波' },
  bpm: 92,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.1, dur: 0.18, notes: join(mA, mB, mC, mB, mA, mB, mC, mD) },
    { wave: 'square', gain: 0.04, dur: 0.15, notes: join(hA, hB, hC, hB, hA, hB, hC, hD) },
    { wave: 'triangle', gain: 0.15, dur: 0.2, notes: join(bA, bB, bC, bB, bA, bB, bC, bD) },
  ],
  kick: { gain: 0.14, hits: rep([T, F, F, F, T, F, F, F], 32) },
  snare: { gain: 0.04, hits: rep([F, F, T, F, F, F, T, F], 32) },
  hihat: { gain: 0.03, hits: [...rep([T, F, T, F, T, F, T, F], 16), ...rep([T, F, T, F, T, T, T, F], 16)] },
};
export default song;
