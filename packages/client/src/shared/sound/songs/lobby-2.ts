...
const song: Song = {
  name: 'Daydream',
  meta: { author: 'Claude Opus 4.6', key: 'C 大调', style: '空灵梦幻', wave: '方波' },
  bpm: 88,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.1, dur: 0.22, notes: join(mA, mB, mAp, mC, mA, mB, mAp, mD) },
    { wave: 'square', gain: 0.03, dur: 0.18, notes: join(hA, hB, hA, hC, hA, hB, hA, hD) },
    { wave: 'triangle', gain: 0.12, dur: 0.25, notes: join(bA, bB, bA, bC, bA, bB, bA, bD) },
  ],
