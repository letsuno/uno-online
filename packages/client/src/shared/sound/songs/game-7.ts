...
const song: Song = {
  name: 'Carnival',
  meta: { author: 'Claude Opus 4.6', key: 'F 大调', style: '拉丁嘉年华', wave: '正弦波' },
  bpm: 132,
  stepsPerBeat: 2,
  tones: [
    { wave: 'sine', gain: 0.18, dur: 0.12, notes: join(mA, mB, mA, mC, mD, mA, mB, mE) },
    { wave: 'square', gain: 0.06, dur: 0.12, notes: join(hA, hB, hA, hC, hD, hA, hB, hE) },
    { wave: 'triangle', gain: 0.17, dur: 0.15, notes: join(bA, bB, bA, bC, bD, bA, bB, bE) },
  ],
  kick: { gain: 0.2, hits: [...rep([T, F, F, T, F, F, T, F], 16), ...rep([T, F, F, F, T, F, F, F], 16)] },
  snare: { gain: 0.09, hits: [...rep([F, F, F, T, F, F, T, F], 16), ...rep([F, F, T, F, F, F, T, F], 16)] },
