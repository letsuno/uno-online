...
const song: Song = {
  name: 'Minuet',
  meta: { author: 'Claude Opus 4.6', key: 'C 大调', style: '巴洛克小步舞', wave: '三角波' },
  bpm: 108,
  stepsPerBeat: 2,
  tones: [
    { wave: 'triangle', gain: 0.14, dur: 0.16, notes: join(mA, mB, mA, mC, mD, mA, mB, mE) },
    { wave: 'sine', gain: 0.06, dur: 0.2, notes: join(hA, hB, hA, hC, hD, hA, hB, hE) },
    { wave: 'triangle', gain: 0.14, dur: 0.2, notes: join(bA, bB, bA, bC, bD, bA, bB, bE) },
  ],
