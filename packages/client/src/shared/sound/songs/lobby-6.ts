...
const song: Song = {
  name: 'Nocturne',
  meta: { author: 'Claude Opus 4.6', key: 'Am/C', style: '浪漫夜曲', wave: '正弦波' },
  bpm: 72,
  stepsPerBeat: 2,
  tones: [
    { wave: 'sine', gain: 0.14, dur: 0.3, notes: join(mA, mB, mC, mA, mD, mB, mC, mE) },
    { wave: 'sine', gain: 0.05, dur: 0.35, notes: join(hA, hB, hC, hA, hD, hB, hC, hE) },
    { wave: 'triangle', gain: 0.1, dur: 0.4, notes: join(bA, bB, bC, bA, bD, bB, bC, bE) },
  ],
  kick: { gain: 0.0, hits: rep([F, F, F, F, F, F, F, F], 32) },
  snare: { gain: 0.0, hits: rep([F, F, F, F, F, F, F, F], 32) },
  hihat: { gain: 0.0, hits: rep([F, F, F, F, F, F, F, F], 32) },
};
export default song;
