...
const song: Song = {
  name: 'Midnight',
  meta: { author: 'Claude Opus 4.6', key: 'D 小调', style: '暗夜氛围', wave: '方波' },
  bpm: 116,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.13, dur: 0.14, notes: join(mA, mB, mC, mA, mD, mE, mB, mD) },
    { wave: 'square', gain: 0.05, dur: 0.14, notes: join(hA, hB, hC, hA, hD, hE, hB, hD) },
    { wave: 'triangle', gain: 0.16, dur: 0.18, notes: join(bA, bB, bC, bA, bD, bE, bB, bD) },
  ],
