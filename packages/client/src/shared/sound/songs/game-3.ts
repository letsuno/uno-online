...
const hB: N[] = [_, _, _, _, C4, _, _, _, _, _, _, _, A3, _, _, _, _, _, _, _, E4, _, _, _, _, _, _, _, D4, _, _, _];
...
const song: Song = {
  name: 'Draw Four!',
  meta: { author: 'Claude Opus 4.6', key: 'A 小调', style: '高速连奏', wave: '方波' },
  bpm: 144,
  stepsPerBeat: 2,
  tones: [
    { wave: 'square', gain: 0.15, dur: 0.1, notes: join(mA, mB, mA, mC, mD, mE, mB, mF) },
    { wave: 'square', gain: 0.07, dur: 0.12, notes: join(hA, hB, hA, hC, hD, hE, hB, hF) },
    { wave: 'triangle', gain: 0.18, dur: 0.15, notes: join(bA, bB, bA, bC, bD, bE, bB, bF) },
  ],
  kick: {
    gain: 0.22,
    hits: [
  ...
  snare: { gain: 0.1, hits: [...rep([F, F, T, F, F, F, T, F], 31), F, T, F, T, T, F, T, T] },
  hihat: {
    gain: 0.04,
    hits: [
      ...rep([T, F, T, F, T, F, T, F], 8),
