...
export default function ColorPicker({ onPick }: ColorPickerProps) {
  ...
  return (
    <div className="fixed inset-0 glass-modal-backdrop flex items-center justify-center z-modal pointer-events-none">
      <AnimatePresence>
        {picked && (
          <motion.div
            key="burst"
      ...
      {!picked && (
        <motion.div
          ...
          className="glass-panel px-8 py-6 flex flex-col items-center gap-4 pointer-events-auto"
        >
