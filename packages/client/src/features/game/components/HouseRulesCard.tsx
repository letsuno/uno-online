...
export default function HouseRulesCard({ embedded = false }: HouseRulesCardProps) {
  ...
  return (
    <div className="hidden md:block fixed left-4 bottom-24 w-chat-w max-h-[60vh] overflow-y-auto scrollbar-thin z-fab bg-card/80 backdrop-blur-sm rounded-xl border border-border p-3">
      {content}
    </div>
  );
}
