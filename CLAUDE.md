...
```
plugins/core/     — auth, profile, admin, room, game, server-info, interaction
plugins/features/ — 扩展功能（签到、积分、商店等，按设计文档待实现）
```
...
```
features/ — auth, game, lobby, profile（以及后续扩展 Feature）
